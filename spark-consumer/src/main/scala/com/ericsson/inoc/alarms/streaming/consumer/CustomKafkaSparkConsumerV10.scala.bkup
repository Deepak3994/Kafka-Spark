 ...
 * Usage: CustomKafkaSparkConsumerV9 <brokers> <topics>
 *   <brokers> is a list of one or more Kafka brokers
 *   <topics> is a list of one or more kafka topics to consume from
 *
 * Example:
 *    $ bin/run-example streaming.CustomKafkaSparkConsumerV9 
 */

object CustomKafkaSparkConsumerV9 {
	...
	sparkConf.setAppName("CustomKafkaSparkConsumerV9")
	...
	//def functionToCreateContext(): StreamingContext = {
		...
		val topics = "Dummy-Alarm-Streams,any-topic,this-topic"
		...
		"value.deserializer" -> classOf[com.ericsson.inoc.alarms.streaming.common.KryoCustSerializerV3],
		...
		println("Dstreams got created .....")	
	        val kafkaMessages = KafkaUtils.createDirectStream[String, AlarmsV3](ssc,PreferConsistent,Subscribe[String,AlarmsV3](topicsSet, kafkaParams))

		val alarmData = kafkaMessages.map(record => (record.timestamp,
							record.key.toLong,
